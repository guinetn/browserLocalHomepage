...
* <kbd>→</kbd> Next chapter (Enter chapter mode when on 1<sup>st</sup> chapter)
* <kbd>←</kbd> Previous chapter (Exit chapter mode when on 1<sup>st</sup> chapter)
...
Chapters syntax: standard markdown + additional syntax to include…
    
* <strong>download.chapter(myfile.md)</strong> : a markdown file:
