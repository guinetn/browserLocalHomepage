...
A framework for administrative tools 
...
***.msc files***
Snap-in control files associated with the MMC on Windows machines to run administrative tasks.
services.msc 
gpedit.msc  
devmgmt.msc         Device Manager

Microsoft Windows ships with native .msc files integrated in the operating system
Support for the creation or importing of custom snap-in control files
...
| certmgr.msc | Certificate Manager, list user certificates |
...
| wmimgmt.msc |	Windows Management Infrastructure - WMI Management	Configure and Control the Windows Management Instrumentation  Service |
