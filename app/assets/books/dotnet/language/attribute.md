...
public class Class1
{
    ...
    [Obsolete("Please use NewMethod2, this will be removed in next version1")]
    public void Method1()
    { }
    public void NewMethod2()
    { }
    
    [Obsolete("Please use NewMethod1, it's mandatory",true)]
    public void Method1()  // any call will get error and not just a simple warning
    { }
}
```
