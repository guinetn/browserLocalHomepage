...
1. Energy is not continuous, but is quantized (Max Planck). The amount of energy equals the frequency of the radiation times Planck's constant. Using this, Einstein later showed that a photon is both a wave and a particle. 

![](assets/quanta_planck.png)

2. Heisenberg's uncertainty principle: you cannot know both a particle’s exact position and it’s exact momentum at the same time. For a particle with mass, this means if you know exactly where a particle is, you don’t know how fast going. If you know exactly how fast it’s going, you don’t know where it is. 

![](assets/heisenberg_uncertain01.png)
...
Comme Einstein l'avait montré, l'énergie présente dans une onde lumineuse est en réalité sous forme de paquets discrets indivisibles, les photons. De même, les électrons présentent des aspects ondulatoires, comme de Broglie l'avait prédit, et on peut faire des expériences de diffraction et d'interférence avec eux. Cette situation est souvent résumée par le terme de « dualité onde-particule » pour la matière et la lumière, et on l'illustre par l'expérience des doubles fentes de Feynman
...
download.page(sciences//physic/quantum_mechanics/schrodinger_equation.md)
...
![effet tunnel](assets/books/sciences/physic/quantum_mechanicsassets/effet-tunnel.jpg)
