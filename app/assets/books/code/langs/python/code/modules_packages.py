...
Namespace packages are a mechanism for splitting a single Python package across multiple directories on disk. Regular packages are self-contained: all parts live in the same directory hierarchy. Namespace packages have no __init__.py module as well.
...
import my_packages.effects.echo

# An alternative way of importing the submodule is:

# pylint: disable=reimported
from my_packages.effects import echo

# Yet another variation is to import the desired function or variable directly:
from my_packages.effects.echo import echo_function
...
def test_packages():
    """Packages."""
    assert my_packages.effects.echo.echo_function() == 'Do echo effect'
