...
<span>download</span>.md(assets/books/toolbox/toolbox_subpage_1.md)
download.md(assets/books/toolbox/toolbox_subpage_1.md)

Use `download.chapter` to get ride of `assets/books/`
<span>download</span>.chapter(toolbox/toolbox_subpage_1.md)
download.page(toolbox/toolbox_subpage_1.md)
