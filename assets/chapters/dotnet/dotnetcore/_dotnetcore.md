...
::::
download.chapter(dotnet/dotnetcore/dotnet_cli.md)
::::
download.chapter(dotnet/dotnetcore/project.json.md)
download.chapter(dotnet/dotnetcore/env_vars.md)
::::
download.chapter(dotnet/depency_injection_ioc.md)
::::
download.chapter(dotnet/dotnetcore/configuration.md)
::::
download.chapter(dotnet/dotnetcore/logging.md)
::::
download.chapter(dotnet/dotnetcore/dotnetcore_on_linux.md)
::::
download.chapter(dotnet/dotnetcore/dotnetcore2.0.md)
::::
download.chapter(dotnet/dotnetcore/dotnetcore3.0.md)
