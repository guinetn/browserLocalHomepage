...
::::
download.chapter(computer_science/architecture_microservices.md)
::::
download.chapter(computer_science/architecture_serverless.md)
::::
download.chapter(computer_science/architecture_event_driven.md)
::::
download.chapter(computer_science/architecture_hexagonal.md)
::::
download.chapter(computer_science/architecture_mvc_mvvm_mvp.md)
::::
download.chapter(computer_science/architecture_client_server.md)
::::
