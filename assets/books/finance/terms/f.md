...
L’argent d’investisseurs est mis en commun dans un fonds dit d’investissements collectifs. Cet argent est investi dans différents titres (immobilier, actions, obligations…).
## Fed - Federal Reserve 
The Central Bank for the United States. 

## FIX - Financial Information eXchange
Protocol devised in the 90s in an attempt to create a common language for electronic trading systems
https://en.wikipedia.org/wiki/Black%E2%80%93Scholes_model
Pricing systems

## Fixed Exchange Rate (Representative Rate) 
An official exchange rate set by monetary authorities for one or more 
currencies. ln practice, even fixed exchange rates fluctuate between 
definite upper and Iower bands, leading to intervention. 

## Fixed Income 
A security that pays a specific level of interest. 
Fixed Income Asset Class
Fixed income security: a bond issued by a government or large company

### Fixed Income Asset Class    
An example of a fixed income security is a bond issued by a government or large company.
 
 
## Flat (Square, Balanced) 
To be neither long nor short is the same as to be flat or square. One 
would have a flat book if he has no positions or if all the positions 
...
Ces fonds d’investissement sélectionnent des sociétés dans lesquelles investir sur plusieurs critères. Ces fonds sont pour la majorité spécialisés par type d’interventions, ce qui correspond à des stades de maturité de l’entreprise différentes (fonds de Capital Risque, fonds de Capital Développement, fonds de LBO).

## FOREX - FOREIGN EXCHANGE 
The simultaneous buying of one currency and selling of another in an OTC (over-the-counter) market. 
Most major FX is quoted against the US Dollar. 

une cotation EUR/USD = 1.0210/40 signifie que le trader 
- achète 1 € pour 1.0210 USD 
- vend 1 € contre 1.0240 USD

https://fixer.io 		Foreign exchange rates and currency conversion JSON API
...
taux change forward = taux change spot + point de swap
Fwd: 1.32  usd/eur	1.30 (taux spot) + 0.2   2bps, 2points de base    
points de la courbe qui permettent de changer taux
...
FRASs are transactions that allow one to borrow/lend at a stated interest 
rate over a specific time period in the future. 

## Front and Back Office 
The front office usually comprises of the trading room and other main 
business activities. 
