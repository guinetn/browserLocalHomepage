...
## Bar Chart 
A type of chart which consists of four significant points: the high and 
the Iow prices, which form the vertical bar, the opening price, which is 
marked With a little horizontal line to the Ieft of the bar, and the closing 
price, which is marked With a little horizontal line of the right of the bar. 

## Base Currency 
The currency in which an investor or issuer maintains its book of 
accounts; the currency that other currencies are quoted against. ln the 
forex market, the US Dollar is normally considered the ´base´ currency 
for quotes, meaning that quotes are expressed as a unit of $1 USD per 
...
Person forecasts that prices of stocks or commodities will fall, especially a person who sells shares hoping to buy them back later at a lower price.

## Bear Market 
A market distinguished by a prolonged period of declining prices accompanied With widespread pessimism. 

## BIC - Bank Identifier Code
an internationally agreed way to identify the beneficiary´s bank and branch
Sometimes referred to as SWIFT codes, though not all SWIFT codes are capable of receiving payments.
e.g CCFRFRPP is HSBC France in Paris 
8 or 11 characters
- 4 digit bank code
