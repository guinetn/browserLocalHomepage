...
download.page(dotnet/collections/tuple.md)

download.page(dotnet/collections/ienumerator.md)
download.page(dotnet/collections/ienumerable.md)

download.page(dotnet/collections/generics.md)

download.page(dotnet/collections/bitarray.md)

download.page(dotnet/collections/hashset.md)
...
download.page(dotnet/collections/queue.md)

download.page(dotnet/collections/stack.md)

download.page(dotnet/collections/hashtable.md)

download.page(dotnet/collections/dictionary.md)

download.page(dotnet/collections/sortedlist.md)
